...
result = zeros(38,38);
for j=1:1:10
order2 = randperm(2*N1);
Xtrain = X_75_train(order2(1:N1),:);
Xtest = X_75_train(order2(N2:(2*N1)),:);
ytrain = Y_75_train(order2(1:N1),:);
ytest = Y_75_train(order2(N2:(2*N1)),:);
