...
Data = sio.loadmat('X_75_train_binary.mat')
X_train = Data['X_75_train_binary']
...
Data = sio.loadmat('X_20.mat')
X_5195 = Data['X_newcom'];
...
np.save("X_ALL_1400_bia.npy",X_train)
print(X_train.shape)
